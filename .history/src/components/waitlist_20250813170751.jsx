        ...
        {expanded && !submitted && (
          ...
          >
            ...
            <p className="text-xs text-white/70 text-center -mt-2 mb-2 px-2">
              By signing up, you agree to receive SMS messages from Eclipse about st status, and account notifications. Message and data rates may apply. Message frequency varies. You can opt out at any time. View our <a href="/privacy" className="underline hover:text-white">Privacy Policy. </a> 
            </p>
            <button
              type="submit"
